...
const (
	GraphState_GRAPH_STATE_PENDING  GraphState = 0
	GraphState_GRAPH_STATE_INDEXING GraphState = 1
	GraphState_GRAPH_STATE_IDLE     GraphState = 2
)

// Enum value maps for GraphState.
var (
	GraphState_name = map[int32]string{
		0: "GRAPH_STATE_PENDING",
		1: "GRAPH_STATE_INDEXING",
		2: "GRAPH_STATE_IDLE",
	}
	GraphState_value = map[string]int32{
...
func (x GraphState) Enum() *GraphState {
	p := new(GraphState)
	*p = x
	return p
}
...
func (GraphState) Descriptor() protoreflect.EnumDescriptor {
	return file_gkg_proto_enumTypes[3].Descriptor()
}

func (GraphState) Type() protoreflect.EnumType {
	return &file_gkg_proto_enumTypes[3]
}

func (x GraphState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GraphState.Descriptor instead.
func (GraphState) EnumDescriptor() ([]byte, []int) {
	return file_gkg_proto_rawDescGZIP(), []int{3}
}
...
type GetGraphStatusResponse struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	State               GraphState             `protobuf:"varint,1,opt,name=state,proto3,enum=gkg.v1.GraphState" json:"state,omitempty"`
	...
	Domains             []*GraphStatusDomain   `protobuf:"bytes,4,rep,name=domains,proto3" json:"domains,omitempty"`
	EdgeCounts          map[string]int64       `protobuf:"bytes,5,rep,name=edge_counts,json=edgeCounts,proto3" json:"edge_counts,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
func (x *GetGraphStatusResponse) GetState() GraphState {
	if x != nil {
		return x.State
	}
	return GraphState_GRAPH_STATE_PENDING
}

func (x *GetGraphStatusResponse) GetInitialBackfillDone() bool {
	if x != nil {
...
func (x *GetGraphStatusResponse) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
func (x *GetGraphStatusResponse) GetEdgeCounts() map[string]int64 {
	if x != nil {
		return x.EdgeCounts
	}
	return nil
...
func (x *GetGraphStatusResponse) GetSdlc() *SdlcProgress {
	if x != nil {
		return x.Sdlc
	}
	return nil
...
func (x *GetGraphStatusResponse) GetCode() *CodeOverview {
	if x != nil {
		return x.Code
	}
	return nil
...
func (x *GetGraphStatusResponse) GetStale() bool {
	if x != nil {
		return x.Stale
	}
	return false
...
func (x *GraphStatusItem) GetStatus() EntityStatus {
	if x != nil {
		return x.Status
	}
...
type SdlcProgress struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	LastCompletedAt string                 `protobuf:"bytes,1,opt,name=last_completed_at,json=lastCompletedAt,proto3" json:"last_completed_at,omitempty"`
	LastStartedAt   string                 `protobuf:"bytes,2,opt,name=last_started_at,json=lastStartedAt,proto3" json:"last_started_at,omitempty"`
	LastDurationMs  int64                  `protobuf:"varint,3,opt,name=last_duration_ms,json=lastDurationMs,proto3" json:"last_duration_ms,omitempty"`
...
func (x *SdlcProgress) GetLastDurationMs() int64 {
	if x != nil {
...
func (x *SdlcProgress) GetCycleCount() int64 {
	if x != nil {
		return x.CycleCount
	}
	return 0
...
type CodeOverview struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	ProjectsIndexed int32                  `protobuf:"varint,1,opt,name=projects_indexed,json=projectsIndexed,proto3" json:"projects_indexed,omitempty"`
	ProjectsTotal   int32                  `protobuf:"varint,2,opt,name=projects_total,json=projectsTotal,proto3" json:"projects_total,omitempty"`
...
func (x *CodeOverview) GetProjectsIndexed() int32 {
	if x != nil {
...
func (x *CodeOverview) GetProjectsTotal() int32 {
	if x != nil {
...
type ProjectCodeOverview struct {
	...
	UpdatedAt     string                      `protobuf:"bytes,3,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
	Branches      map[string]*BranchCodeStats `protobuf:"bytes,4,rep,name=branches,proto3" json:"branches,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ProjectCodeOverview) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
func (x *ProjectCodeOverview) GetBranches() map[string]*BranchCodeStats {
	if x != nil {
		return x.Branches
	}
	return nil
...
type BranchCodeStats struct {
	...
	NodeCounts    map[string]int64       `protobuf:"bytes,3,rep,name=node_counts,json=nodeCounts,proto3" json:"node_counts,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	EdgeCounts    map[string]int64       `protobuf:"bytes,4,rep,name=edge_counts,json=edgeCounts,proto3" json:"edge_counts,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BranchCodeStats) GetCommit() string {
	if x != nil {
		return x.Commit
	}
	return ""
...
func (x *BranchCodeStats) GetNodeCounts() map[string]int64 {
	if x != nil {
		return x.NodeCounts
	}
	return nil
...
func (x *BranchCodeStats) GetEdgeCounts() map[string]int64 {
	if x != nil {
		return x.EdgeCounts
	}
	return nil
...
const file_gkg_proto_rawDesc = "" +
	...
	"\x0etraversal_path\x18\x01 \x01(\tR\rtraversalPath\"\xc4\x03\n" +
	"\x16GetGraphStatusResponse\x12(\n" +
	"\x05state\x18\x01 \x01(\x0e2\x12.gkg.v1.GraphStateR\x05state\x122\n" +
	"\x15initial_backfill_done\x18\x02 \x01(\bR\x13initialBackfillDone\x12\x1d\n" +
	"\n" +
	"updated_at\x18\x03 \x01(\tR\tupdatedAt\x123\n" +
	"\adomains\x18\x04 \x03(\v2\x19.gkg.v1.GraphStatusDomainR\adomains\x12O\n" +
	"\vedge_counts\x18\x05 \x03(\v2..gkg.v1.GetGraphStatusResponse.EdgeCountsEntryR\n" +
	"edgeCounts\x12(\n" +
	...
	"\x04name\x18\x01 \x01(\tR\x04name\x12-\n" +
	"\x05items\x18\x02 \x03(\v2\x17.gkg.v1.GraphStatusItemR\x05items\"i\n" +
	...
	"\x10last_duration_ms\x18\x03 \x01(\x03R\x0elastDurationMs\x12\x1f\n" +
	"\vcycle_count\x18\x04 \x01(\x03R\n" +
	"cycleCount\x12\x1d\n" +
	"\n" +
	"last_error\x18\x05 \x01(\tR\tlastError\"\xc1\x01\n" +
	"\fCodeOverview\x12)\n" +
	"\x10projects_indexed\x18\x01 \x01(\x05R\x0fprojectsIndexed\x12%\n" +
	"\x0eprojects_total\x18\x02 \x01(\x05R\rprojectsTotal\x12&\n" +
	"\x0flast_indexed_at\x18\x03 \x01(\tR\rlastIndexedAt\x127\n" +
	"\bprojects\x18\x04 \x03(\v2\x1b.gkg.v1.ProjectCodeOverviewR\bprojects\"\x97\x02\n" +
	"\x13ProjectCodeOverview\x12\x1d\n" +
	"\n" +
	"project_id\x18\x01 \x01(\x03R\tprojectId\x12%\n" +
	"\x0etraversal_path\x18\x02 \x01(\tR\rtraversalPath\x12\x1d\n" +
	"\n" +
	"updated_at\x18\x03 \x01(\tR\tupdatedAt\x12E\n" +
	"\bbranches\x18\x04 \x03(\v2).gkg.v1.ProjectCodeOverview.BranchesEntryR\bbranches\x1aT\n" +
	"\rBranchesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.gkg.v1.BranchCodeStatsR\x05value:\x028\x01\"\xda\x02\n" +
	"\x0fBranchCodeStats\x12\x16\n" +
	"\x06commit\x18\x01 \x01(\tR\x06commit\x12\x1d\n" +
	"\n" +
	"indexed_at\x18\x02 \x01(\tR\tindexedAt\x12H\n" +
	"\vnode_counts\x18\x03 \x03(\v2'.gkg.v1.BranchCodeStats.NodeCountsEntryR\n" +
	"nodeCounts\x12H\n" +
	"\vedge_counts\x18\x04 \x03(\v2'.gkg.v1.BranchCodeStats.EdgeCountsEntryR\n" +
	"edgeCounts\x1a=\n" +
	...
	"\x18CLUSTER_STATUS_UNHEALTHY\x10\x03*U\n" +
	"\n" +
	"GraphState\x12\x17\n" +
	"\x13GRAPH_STATE_PENDING\x10\x00\x12\x18\n" +
	"\x14GRAPH_STATE_INDEXING\x10\x01\x12\x14\n" +
	"\x10GRAPH_STATE_IDLE\x10\x02*L\n" +
	"\fEntityStatus\x12\x19\n" +
	"\x15ENTITY_STATUS_PENDING\x10\x00\x12\x1b\n" +
	"\x17ENTITY_STATUS_COMPLETED\x10\x02\"\x04\b\x01\x10\x012\xa0\x03\n" +
...
var file_gkg_proto_goTypes = []any{
	...
	(GraphState)(0),                  // 3: gkg.v1.GraphState
	...
	(*GraphStatusDomain)(nil),        // 34: gkg.v1.GraphStatusDomain
	(*GraphStatusItem)(nil),          // 35: gkg.v1.GraphStatusItem
	(*SdlcProgress)(nil),             // 36: gkg.v1.SdlcProgress
	(*CodeOverview)(nil),             // 37: gkg.v1.CodeOverview
	(*ProjectCodeOverview)(nil),      // 38: gkg.v1.ProjectCodeOverview
	(*BranchCodeStats)(nil),          // 39: gkg.v1.BranchCodeStats
	nil,                              // 40: gkg.v1.ResourceAuthorization.AuthorizedEntry
	nil,                              // 41: gkg.v1.ComponentHealth.MetricsEntry
	nil,                              // 42: gkg.v1.GetGraphStatusResponse.EdgeCountsEntry
	nil,                              // 43: gkg.v1.ProjectCodeOverview.BranchesEntry
	nil,                              // 44: gkg.v1.BranchCodeStats.NodeCountsEntry
	nil,                              // 45: gkg.v1.BranchCodeStats.EdgeCountsEntry
}
var file_gkg_proto_depIdxs = []int32{
	...
	40, // 19: gkg.v1.ResourceAuthorization.authorized:type_name -> gkg.v1.ResourceAuthorization.AuthorizedEntry
	...
	41, // 27: gkg.v1.ComponentHealth.metrics:type_name -> gkg.v1.ComponentHealth.MetricsEntry
	3,  // 28: gkg.v1.GetGraphStatusResponse.state:type_name -> gkg.v1.GraphState
	34, // 29: gkg.v1.GetGraphStatusResponse.domains:type_name -> gkg.v1.GraphStatusDomain
	42, // 30: gkg.v1.GetGraphStatusResponse.edge_counts:type_name -> gkg.v1.GetGraphStatusResponse.EdgeCountsEntry
	36, // 31: gkg.v1.GetGraphStatusResponse.sdlc:type_name -> gkg.v1.SdlcProgress
	37, // 32: gkg.v1.GetGraphStatusResponse.code:type_name -> gkg.v1.CodeOverview
	35, // 33: gkg.v1.GraphStatusDomain.items:type_name -> gkg.v1.GraphStatusItem
	4,  // 34: gkg.v1.GraphStatusItem.status:type_name -> gkg.v1.EntityStatus
	38, // 35: gkg.v1.CodeOverview.projects:type_name -> gkg.v1.ProjectCodeOverview
	43, // 36: gkg.v1.ProjectCodeOverview.branches:type_name -> gkg.v1.ProjectCodeOverview.BranchesEntry
	44, // 37: gkg.v1.BranchCodeStats.node_counts:type_name -> gkg.v1.BranchCodeStats.NodeCountsEntry
	45, // 38: gkg.v1.BranchCodeStats.edge_counts:type_name -> gkg.v1.BranchCodeStats.EdgeCountsEntry
	39, // 39: gkg.v1.ProjectCodeOverview.BranchesEntry.value:type_name -> gkg.v1.BranchCodeStats
	24, // 40: gkg.v1.KnowledgeGraphService.ListTools:input_type -> gkg.v1.ListToolsRequest
	5,  // 41: gkg.v1.KnowledgeGraphService.ExecuteQuery:input_type -> gkg.v1.ExecuteQueryMessage
	10, // 42: gkg.v1.KnowledgeGraphService.GetGraphSchema:input_type -> gkg.v1.GetGraphSchemaRequest
	27, // 43: gkg.v1.KnowledgeGraphService.GetClusterHealth:input_type -> gkg.v1.GetClusterHealthRequest
	32, // 44: gkg.v1.KnowledgeGraphService.GetGraphStatus:input_type -> gkg.v1.GetGraphStatusRequest
	25, // 45: gkg.v1.KnowledgeGraphService.ListTools:output_type -> gkg.v1.ListToolsResponse
	5,  // 46: gkg.v1.KnowledgeGraphService.ExecuteQuery:output_type -> gkg.v1.ExecuteQueryMessage
	11, // 47: gkg.v1.KnowledgeGraphService.GetGraphSchema:output_type -> gkg.v1.GetGraphSchemaResponse
	28, // 48: gkg.v1.KnowledgeGraphService.GetClusterHealth:output_type -> gkg.v1.GetClusterHealthResponse
	33, // 49: gkg.v1.KnowledgeGraphService.GetGraphStatus:output_type -> gkg.v1.GetGraphStatusResponse
