...
...                 issue + note already indexed), so per-entity waits stay short.
...
Project Issue And Note Are Indexed
    ...
    Wait For Node Indexed    Project    ${project["id"]}    ${project_name}    timeout=120s
