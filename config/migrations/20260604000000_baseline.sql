-- Baseline migration [AUTOGENERATED — DO NOT EDIT MANUALLY]
-- Full graph schema as of SCHEMA_VERSION=55.
-- Regenerate with: mise schema:generate:migration
...
-- +down
DROP DICTIONARY IF EXISTS gl_project_traversal_paths_dict;
DROP DICTIONARY IF EXISTS gl_group_traversal_paths_dict;
DROP TABLE IF EXISTS namespace_deletion_schedule;
DROP TABLE IF EXISTS gl_work_item;
DROP TABLE IF EXISTS gl_vulnerability_scanner;
DROP TABLE IF EXISTS gl_vulnerability_occurrence;
DROP TABLE IF EXISTS gl_vulnerability_identifier;
DROP TABLE IF EXISTS gl_vulnerability;
DROP TABLE IF EXISTS gl_user;
DROP TABLE IF EXISTS gl_stage;
DROP TABLE IF EXISTS gl_security_scan;
DROP TABLE IF EXISTS gl_runner;
DROP TABLE IF EXISTS gl_project;
DROP TABLE IF EXISTS gl_pipeline;
DROP TABLE IF EXISTS gl_note;
DROP TABLE IF EXISTS gl_milestone;
DROP TABLE IF EXISTS gl_merge_request_diff_file;
DROP TABLE IF EXISTS gl_merge_request_diff;
DROP TABLE IF EXISTS gl_merge_request;
DROP TABLE IF EXISTS gl_label;
DROP TABLE IF EXISTS gl_job_metadata;
DROP TABLE IF EXISTS gl_job;
DROP TABLE IF EXISTS gl_imported_symbol;
DROP TABLE IF EXISTS gl_group;
DROP TABLE IF EXISTS gl_finding;
DROP TABLE IF EXISTS gl_file;
DROP TABLE IF EXISTS gl_environment;
DROP TABLE IF EXISTS gl_edge;
DROP TABLE IF EXISTS gl_directory;
DROP TABLE IF EXISTS gl_deployment;
DROP TABLE IF EXISTS gl_definition;
DROP TABLE IF EXISTS gl_code_edge;
DROP TABLE IF EXISTS gl_ci_edge;
DROP TABLE IF EXISTS gl_branch;
DROP TABLE IF EXISTS code_indexing_checkpoint;
