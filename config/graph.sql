-- SCHEMA_VERSION=86 [AUTOGENERATED — DO NOT EDIT MANUALLY]
...
CREATE TABLE IF NOT EXISTS gl_external_branch (
    id Int64 CODEC(T64, ZSTD(1)),
    traversal_path String CODEC(ZSTD(1)),
    project_id Int64 CODEC(T64, ZSTD(1)),
    external_repository_id Int64 DEFAULT 0 CODEC(T64, ZSTD(1)),
    name String CODEC(ZSTD(1)),
    is_default Bool DEFAULT true,
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(Delta(8), ZSTD(1)),
    _deleted Bool DEFAULT false,
    INDEX idx_id id TYPE bloom_filter(0.0001) GRANULARITY 1,
    INDEX idx_external_repository_id external_repository_id TYPE bloom_filter(0.0001) GRANULARITY 1,
    INDEX idx_name name TYPE text(tokenizer = splitByNonAlpha) GRANULARITY 1,
    INDEX idx_name_ngram name TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1
) ENGINE = ReplacingMergeTree(_version, _deleted)
ORDER BY (traversal_path, external_repository_id, id)
SETTINGS index_granularity = 1024, allow_experimental_replacing_merge_with_cleanup = 1, auto_statistics_types = 'minmax, uniq, countmin';

CREATE TABLE IF NOT EXISTS gl_external_definition (
    id Int64 CODEC(T64, ZSTD(1)),
    traversal_path String CODEC(ZSTD(1)),
    project_id Int64 CODEC(T64, ZSTD(1)),
    external_repository_id Int64 DEFAULT 0 CODEC(T64, ZSTD(1)),
...
ORDER BY (traversal_path, external_repository_id, branch, id)
SETTINGS index_granularity = 1024, allow_experimental_replacing_merge_with_cleanup = 1, auto_statistics_types = 'minmax, uniq, countmin';

CREATE TABLE IF NOT EXISTS gl_external_directory (
    id Int64 CODEC(T64, ZSTD(1)),
    traversal_path String CODEC(ZSTD(1)),
    project_id Int64 CODEC(T64, ZSTD(1)),
    external_repository_id Int64 DEFAULT 0 CODEC(T64, ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_external_file (
    id Int64 CODEC(T64, ZSTD(1)),
    traversal_path String CODEC(ZSTD(1)),
    project_id Int64 CODEC(T64, ZSTD(1)),
    external_repository_id Int64 DEFAULT 0 CODEC(T64, ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_external_imported_symbol (
    id Int64 CODEC(T64, ZSTD(1)),
    traversal_path String CODEC(ZSTD(1)),
    project_id Int64 CODEC(T64, ZSTD(1)),
    external_repository_id Int64 DEFAULT 0 CODEC(T64, ZSTD(1)),
