-- SCHEMA_VERSION=18 [AUTOGENERATED — DO NOT EDIT MANUALLY]
...
CREATE TABLE IF NOT EXISTS gl_code_edge (
    ...
    source_work_item_type LowCardinality(Nullable(String)) CODEC(LZ4),
    ...
    target_work_item_type LowCardinality(Nullable(String)) CODEC(LZ4),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
