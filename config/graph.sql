-- SCHEMA_VERSION=4 [AUTOGENERATED — DO NOT EDIT MANUALLY]
...
CREATE TABLE IF NOT EXISTS gl_merge_request (
    ...
    metric_latest_build_started_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_latest_build_finished_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_first_deployed_to_production_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_merged_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_merged_by_id Nullable(Int64) CODEC(ZSTD(1)),
    metric_latest_closed_by_id Nullable(Int64) CODEC(ZSTD(1)),
    metric_latest_closed_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_first_comment_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_first_commit_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_last_commit_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_diff_size Nullable(Int64) CODEC(ZSTD(1)),
    metric_modified_paths_size Nullable(Int64) CODEC(ZSTD(1)),
    metric_commits_count Nullable(Int64) CODEC(ZSTD(1)),
    metric_first_approved_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_first_reassigned_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    metric_added_lines Nullable(Int64) CODEC(ZSTD(1)),
    metric_removed_lines Nullable(Int64) CODEC(ZSTD(1)),
    metric_first_contribution Bool DEFAULT false,
    metric_pipeline_id Nullable(Int64) CODEC(ZSTD(1)),
    metric_reviewer_first_assigned_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    traversal_path String DEFAULT '0/' CODEC(ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
