-- SCHEMA_VERSION=65 [AUTOGENERATED — DO NOT EDIT MANUALLY]
...
CREATE TABLE IF NOT EXISTS gl_pm_advisory (
    id Int64 CODEC(Delta(8), LZ4),
    advisory_xid String DEFAULT '' CODEC(ZSTD(1)),
    source_xid LowCardinality(String) DEFAULT '' CODEC(LZ4),
    cve Nullable(String) CODEC(ZSTD(1)),
    title Nullable(String) CODEC(ZSTD(1)),
    description Nullable(String) CODEC(ZSTD(1)),
    cvss_v2 Nullable(String) CODEC(ZSTD(1)),
    cvss_v3 Nullable(String) CODEC(ZSTD(1)),
    cvss_v4 Nullable(String) CODEC(ZSTD(1)),
    identifiers String DEFAULT '' CODEC(ZSTD(1)),
    ...
    _deleted Bool DEFAULT false,
    INDEX idx_id id TYPE bloom_filter(0.0001) GRANULARITY 1,
    INDEX idx_advisory_xid advisory_xid TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
    INDEX idx_source_xid source_xid TYPE set(8) GRANULARITY 2,
    INDEX idx_cve cve TYPE bloom_filter(0.0001) GRANULARITY 1,
    INDEX idx_published_date published_date TYPE minmax GRANULARITY 1,
    INDEX idx_created_at created_at TYPE minmax GRANULARITY 1,
    INDEX idx_updated_at updated_at TYPE minmax GRANULARITY 1
) ENGINE = ReplacingMergeTree(_version, _deleted)
...
CREATE TABLE IF NOT EXISTS gl_pm_affected_package (
    id Int64 CODEC(Delta(8), LZ4),
    pm_advisory_id Int64 CODEC(Delta(8), LZ4),
    purl_type LowCardinality(String) DEFAULT '' CODEC(LZ4),
    ...
    solution Nullable(String) CODEC(ZSTD(1)),
    overridden_advisory_fields String DEFAULT '{}' CODEC(ZSTD(1)),
    versions String DEFAULT '' CODEC(ZSTD(1)),
    created_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    updated_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
    INDEX idx_id id TYPE bloom_filter(0.0001) GRANULARITY 1,
    INDEX idx_pm_advisory_id pm_advisory_id TYPE bloom_filter(0.0001) GRANULARITY 1,
    INDEX idx_purl_type purl_type TYPE set(32) GRANULARITY 2,
    INDEX idx_package_name package_name TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
    INDEX idx_created_at created_at TYPE minmax GRANULARITY 1,
    INDEX idx_updated_at updated_at TYPE minmax GRANULARITY 1
) ENGINE = ReplacingMergeTree(_version, _deleted)
ORDER BY (id) PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS gl_pm_cve_enrichment (
    id Int64 CODEC(Delta(8), LZ4),
    ...
    _deleted Bool DEFAULT false,
    INDEX idx_id id TYPE bloom_filter(0.0001) GRANULARITY 1,
    INDEX idx_cve cve TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
    INDEX idx_is_known_exploit is_known_exploit TYPE minmax GRANULARITY 1,
    INDEX idx_created_at created_at TYPE minmax GRANULARITY 1,
    INDEX idx_updated_at updated_at TYPE minmax GRANULARITY 1
) ENGINE = ReplacingMergeTree(_version, _deleted)
ORDER BY (id) PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS gl_pm_license (
    ...
    _deleted Bool DEFAULT false,
    INDEX idx_id id TYPE bloom_filter(0.0001) GRANULARITY 1,
    INDEX idx_spdx_identifier spdx_identifier TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
    INDEX idx_created_at created_at TYPE minmax GRANULARITY 1,
    INDEX idx_updated_at updated_at TYPE minmax GRANULARITY 1
) ENGINE = ReplacingMergeTree(_version, _deleted)
ORDER BY (id) PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS gl_pm_package (
    ...
    purl_type LowCardinality(String) DEFAULT '' CODEC(LZ4),
    name String DEFAULT '' CODEC(ZSTD(1)),
    licenses Nullable(String) CODEC(ZSTD(1)),
    created_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    updated_at Nullable(DateTime64(6, 'UTC')) CODEC(Delta(8), ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
...
CREATE TABLE IF NOT EXISTS gl_pm_package_version (
    id Int64 CODEC(Delta(8), LZ4),
    pm_package_id Int64 CODEC(Delta(8), LZ4),
    ...
    INDEX idx_version version TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
    INDEX idx_created_at created_at TYPE minmax GRANULARITY 1,
    INDEX idx_updated_at updated_at TYPE minmax GRANULARITY 1
) ENGINE = ReplacingMergeTree(_version, _deleted)
ORDER BY (id) PRIMARY KEY (id)
