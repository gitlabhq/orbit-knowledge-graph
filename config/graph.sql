-- SCHEMA_VERSION=26 [AUTOGENERATED — DO NOT EDIT MANUALLY]
...
CREATE TABLE IF NOT EXISTS gl_deployment (
    ...
    deployable_id Int64 DEFAULT 0 CODEC(ZSTD(1)),
    on_stop String DEFAULT '' CODEC(ZSTD(1)),
    archived Bool DEFAULT false,
    created_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    finished_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    updated_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_environment (
    ...
    auto_stop_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    auto_delete_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    auto_stop_setting LowCardinality(String) DEFAULT 'always' CODEC(LZ4),
    cluster_agent_id Int64 DEFAULT 0 CODEC(ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_group (
    ...
    INDEX idx_full_path_ngram full_path TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
    INDEX idx_description description TYPE text(tokenizer = splitByNonAlpha) GRANULARITY 1,
    INDEX idx_description_ngram description TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
    PROJECTION by_id (SELECT * ORDER BY id),
    PROJECTION tp_count (
...
CREATE TABLE IF NOT EXISTS gl_imported_symbol (
    ...
    INDEX idx_identifier_name_ngram identifier_name TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
    INDEX idx_file_path file_path TYPE text(tokenizer = splitByString(['/'])) GRANULARITY 1,
    INDEX idx_file_path_ngram file_path TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
...
CREATE TABLE IF NOT EXISTS gl_job (
    ...
    retried Bool DEFAULT false,
    failure_reason String DEFAULT '' CODEC(ZSTD(1)),
    created_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    started_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    finished_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    queued_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    type LowCardinality(String) DEFAULT '' CODEC(LZ4),
    runner_id Int64 DEFAULT 0 CODEC(ZSTD(1)),
    timeout Int64 DEFAULT 0 CODEC(ZSTD(1)),
    timeout_source LowCardinality(String) DEFAULT '' CODEC(LZ4),
    exit_code Int64 DEFAULT 0 CODEC(ZSTD(1)),
    scheduling_type LowCardinality(String) DEFAULT '' CODEC(LZ4),
    pipeline_id Int64 DEFAULT 0 CODEC(ZSTD(1)),
    auto_canceled_by_id Int64 DEFAULT 0 CODEC(ZSTD(1)),
    traversal_path String DEFAULT '0/' CODEC(ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
...
CREATE TABLE IF NOT EXISTS gl_job_metadata (
    ...
    interruptible Bool DEFAULT false,
    timeout Int64 DEFAULT 0 CODEC(ZSTD(1)),
    timeout_source LowCardinality(String) DEFAULT '' CODEC(LZ4),
    exit_code Int64 DEFAULT 0 CODEC(ZSTD(1)),
    has_exposed_artifacts Bool DEFAULT false,
...
CREATE TABLE IF NOT EXISTS gl_merge_request (
    id Int64 CODEC(Delta(8), ZSTD(1)),
    iid Int64 DEFAULT 0 CODEC(ZSTD(1)),
    title String DEFAULT '' CODEC(ZSTD(1)),
    description String DEFAULT '' CODEC(ZSTD(3)),
    ...
    discussion_locked Bool DEFAULT false,
    prepared_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    project_id Int64 CODEC(ZSTD(1)),
    merged_commit_sha String DEFAULT '' CODEC(ZSTD(1)),
    squash_commit_sha String DEFAULT '' CODEC(ZSTD(1)),
    latest_build_started_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    latest_build_finished_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    first_deployed_to_production_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    merged_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    latest_closed_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    first_comment_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    first_commit_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    last_commit_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    diff_size Int64 DEFAULT 0 CODEC(ZSTD(1)),
    modified_paths_size Int64 DEFAULT 0 CODEC(ZSTD(1)),
    commits_count Int64 DEFAULT 0 CODEC(ZSTD(1)),
    first_approved_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    first_reassigned_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    added_lines Int64 DEFAULT 0 CODEC(ZSTD(1)),
    removed_lines Int64 DEFAULT 0 CODEC(ZSTD(1)),
    first_contribution Bool DEFAULT false,
    reviewer_first_assigned_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    traversal_path String DEFAULT '0/' CODEC(ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
...
CREATE TABLE IF NOT EXISTS gl_merge_request_diff (
    ...
    commits_count Int64 DEFAULT 0 CODEC(ZSTD(1)),
    files_count Int64 DEFAULT 0 CODEC(ZSTD(1)),
    project_id Int64 CODEC(ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_milestone (
    ...
    description String DEFAULT '' CODEC(ZSTD(3)),
    state String DEFAULT '' CODEC(ZSTD(1)),
    due_date Date32 DEFAULT '1970-01-01' CODEC(Delta(4), ZSTD(1)),
    start_date Date32 DEFAULT '1970-01-01' CODEC(Delta(4), ZSTD(1)),
    created_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    updated_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    traversal_path String DEFAULT '0/' CODEC(ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_note (
    ...
    noteable_id Int64 DEFAULT 0 CODEC(ZSTD(1)),
    line_code String DEFAULT '' CODEC(ZSTD(1)),
    commit_id String DEFAULT '' CODEC(ZSTD(1)),
    st_diff String DEFAULT '' CODEC(ZSTD(3)),
    discussion_id String DEFAULT '' CODEC(ZSTD(1)),
    resolved_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_pipeline (
    ...
    tag Bool DEFAULT false,
    duration Int64 DEFAULT 0 CODEC(ZSTD(1)),
    failure_reason String DEFAULT '' CODEC(ZSTD(1)),
    created_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    started_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    finished_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    committed_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    updated_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_project (
    ...
    updated_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    archived Bool DEFAULT false,
    star_count Int64 DEFAULT 0 CODEC(ZSTD(1)),
    last_activity_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    traversal_path String DEFAULT '0/' CODEC(ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
    INDEX idx_archived archived TYPE minmax GRANULARITY 1,
...
CREATE TABLE IF NOT EXISTS gl_runner (
    ...
    maximum_timeout Int64 DEFAULT 0 CODEC(ZSTD(1)),
    organization_id Int64 DEFAULT 0 CODEC(ZSTD(1)),
    created_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    contacted_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
...
CREATE TABLE IF NOT EXISTS gl_stage (
    ...
    name String DEFAULT '' CODEC(ZSTD(1)),
    status LowCardinality(String) DEFAULT '' CODEC(LZ4),
    position Int64 DEFAULT 0 CODEC(ZSTD(1)),
    created_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    updated_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    pipeline_id Int64 DEFAULT 0 CODEC(ZSTD(1)),
    traversal_path String DEFAULT '0/' CODEC(ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_user (
    ...
    last_activity_on Date32 DEFAULT '1970-01-01' CODEC(Delta(4), ZSTD(1)),
...
CREATE TABLE IF NOT EXISTS gl_vulnerability (
    ...
    created_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    updated_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    detected_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    resolved_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    confirmed_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    dismissed_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    traversal_path String DEFAULT '0/' CODEC(ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
    INDEX idx_state state TYPE set(4) GRANULARITY 2,
...
CREATE TABLE IF NOT EXISTS gl_vulnerability_occurrence (
    ...
    INDEX idx_cve_ngram cve TYPE ngrambf_v1(3, 512, 2, 0) GRANULARITY 1,
    PROJECTION by_id (SELECT * ORDER BY id),
    PROJECTION tp_count (
      SELECT traversal_path, uniq(id)
      GROUP BY traversal_path
...
CREATE TABLE IF NOT EXISTS gl_work_item (
    ...
    due_date Date32 DEFAULT '1970-01-01' CODEC(Delta(4), ZSTD(1)),
    start_date Date32 DEFAULT '1970-01-01' CODEC(Delta(4), ZSTD(1)),
    weight Int64 DEFAULT 0 CODEC(ZSTD(1)),
    created_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    updated_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    closed_at DateTime64(6, 'UTC') DEFAULT '1970-01-01 00:00:00' CODEC(Delta(8), ZSTD(1)),
    traversal_path String DEFAULT '0/' CODEC(ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
    INDEX idx_state state TYPE set(10) GRANULARITY 2,
