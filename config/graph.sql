-- SCHEMA_VERSION=32 [AUTOGENERATED — DO NOT EDIT MANUALLY]
...
CREATE TABLE IF NOT EXISTS gl_ci_edge (
    ...
    source_tags Array(LowCardinality(String)) CODEC(ZSTD(1)),
    target_tags Array(LowCardinality(String)) CODEC(ZSTD(1)),
    _version DateTime64(6, 'UTC') DEFAULT now64(6) CODEC(ZSTD(1)),
    _deleted Bool DEFAULT false,
