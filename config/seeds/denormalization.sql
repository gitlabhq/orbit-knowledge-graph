...
INSERT INTO gl_vulnerability (id, title, state, severity, report_type, resolved_on_default_branch, present_on_default_branch, project_id, traversal_path) VALUES
    (200, 'SQL Injection',  'detected',  'critical', 'sast',  false, true,  20, '1/10/20/'),
    (201, 'XSS',            'detected',  'high',     'sast',  false, true,  20, '1/10/20/'),
    (202, 'CSRF',           'resolved',  'critical', 'dast',  true,  false, 20, '1/10/20/'),
...
INSERT INTO gl_pipeline (id, iid, status, ref, source, traversal_path, project_id) VALUES
    (400, 1, 'failed',  'main',      'push',    '1/10/20/', 20),
    (401, 2, 'success', 'main',      'push',    '1/10/20/', 20),
    (402, 3, 'failed',  'feature-1', 'push',    '1/10/20/', 20);
