//! Builders for the Siphon NATS wire format (zstd-compressed protobuf).
//!
//! Vendored from `crates/indexer/src/orchestrator/siphon/wire.rs` to avoid
//! pulling the entire indexer dep tree (code-graph, rust-analyzer, tree-sitter)
//! into xtask.
#![allow(dead_code)]
...
pub fn enabled_namespace_columns(root_namespace_id: i64, traversal_path: &str) -> EventBuilder {
    EventBuilder::new()
