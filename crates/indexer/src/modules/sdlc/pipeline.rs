...
impl Pipeline {
    ...
    ///
    /// Takes the page by value so each block is freed as soon as it is transformed,
    /// and nothing of the input page survives into the write and read-ahead window.
