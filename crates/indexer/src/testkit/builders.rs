...
use gkg_server_config::{
    ClickHouseConfiguration, EngineConfiguration, EntityIndexingHandlerConfig,
...
///
/// Sets `datalake_batch_size` to 1 for the entity indexing handler so tests
/// process one row at a time. Uses the provided ClickHouse config for both graph and datalake.
    ...
    IndexerConfig {
        ...
        engine: EngineConfiguration {
            handlers: HandlersConfiguration {
                entity_indexing: EntityIndexingHandlerConfig {
