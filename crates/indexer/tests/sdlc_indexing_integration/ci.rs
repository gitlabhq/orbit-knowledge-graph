...
pub async fn processes_pipelines(context: &TestContext) {
    ...
    let result = context
        .query("SELECT * FROM gl_pipeline FINAL ORDER BY id")
        .await;
...
pub async fn processes_stages(context: &TestContext) {
    ...
    let result = context
        .query("SELECT * FROM gl_stage FINAL ORDER BY id")
        .await;
...
pub async fn processes_jobs(context: &TestContext) {
    ...
    let result = context
        .query("SELECT * FROM gl_job FINAL ORDER BY id")
        .await;
