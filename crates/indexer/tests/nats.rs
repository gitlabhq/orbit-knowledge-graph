...
async fn nats_broker() {
    ...
    // publish and subscribe
    {
        ...
        let received_event: TestEvent =
            received.envelope.to_event().expect("failed to deserialize");
    ...
    // auto creates stream with configured settings
    {
        let config = NatsConfiguration {
            url: url.clone(),
