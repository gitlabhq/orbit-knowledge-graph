...
impl QuotaCache {
    pub(crate) fn new(client: Arc<QuotaClient>, max_entries: u64) -> Self {
        ...
        let entries_gauge = orbit_observability::billing::quota::QUOTA_CACHE_ENTRIES
...
fn outcome_label(decision: &QuotaDecision) -> &'static str {
    use orbit_observability::billing::quota::values::{ALLOW, DENY};
    match decision {
...
fn record_cdot_duration(secs: f64, outcome: &'static str) {
    use orbit_observability::billing::quota::labels::OUTCOME;
