...
pub use object_storage::{
    GcsAuth, GcsConfig, OBJECT_STORAGE_SECRET_DIR, ObjectStorageConfig, ObjectStorageConfigError,
    ObjectStorageHttpConfig, ObjectStorageProvider, ObjectStorageRetryConfig,
    ObjectStorageTlsConfig, S3Auth, S3Config,
};
