...
impl SecurityContext {
    ...
    /// with the legacy Reporter access level. Kept for tests and for the
    /// backward-compatibility path where a JWT only carries the flat
    /// `group_traversal_ids` array.
