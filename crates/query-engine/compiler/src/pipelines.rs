...
///
/// ```text
/// JSON → Validate → Normalize → Lower → Optimize → Paginate → Enforce → Security → Check → Codegen
/// ```
...
///
/// ```text
/// Input → Lower → Optimize → Paginate → Enforce → Security → Check → Codegen
/// ```
...
///
/// ```text
/// Input → Lower → Optimize → Paginate → Enforce → HydrationCodegen
/// ```
