//! Shared builders for the v2 lowerer.
//!
//! Edge chain construction, hydration, denorm tags, node constraints.
//! Types live in `types.rs`; this module has the construction logic.
