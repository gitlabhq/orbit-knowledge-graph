...
/// Assembles the complete DuckDB DDL: ontology-driven graph tables plus
/// the manifest table, with a SCHEMA_VERSION header.
pub fn generate_local_ddl(ontology: &ontology::Ontology) -> String {
