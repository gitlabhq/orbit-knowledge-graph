...
pub struct ResultContext {
    ...
    /// Edge metadata for traversal/aggregation queries. Populated from `Input.relationships`
    /// during `enforce_return`. Enables the formatter to read edge columns by prefix
    /// instead of scanning column names.
    edges: Vec<EdgeMeta>,
}
