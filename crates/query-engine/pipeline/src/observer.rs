...
pub trait PipelineObserver: Send {
    ...
    /// Structural metadata about the compiled query. Called once after
    /// successful compilation. Default no-op.
    fn set_query_info(&mut self, _info: QueryInfo) {}
