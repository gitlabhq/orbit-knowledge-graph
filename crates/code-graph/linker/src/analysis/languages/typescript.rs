...
impl crate::analysis::analyzer_trait::LanguageAnalyzer for TypeScriptAnalyzer {
    fn process_definitions(
        ...
        TypeScriptAnalyzer::process_definitions(
            self,
            file_result,
            relative_file_path,
            definition_map,
    ...
    fn process_imports(
        ...
        TypeScriptAnalyzer::process_imports(
            self,
            file_result,
            relative_file_path,
            imported_symbol_map,
    ...
    fn add_definition_relationships(
        ...
        TypeScriptAnalyzer::add_definition_relationships(
            self,
            definition_map,
            imported_symbol_map,
            relationships,
