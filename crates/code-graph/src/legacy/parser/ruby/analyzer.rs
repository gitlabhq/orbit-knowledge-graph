...
use crate::legacy::parser::references::ReferenceInfo;
...
use crate::legacy::parser::ruby::types::{RubyDefinitionType, RubyImportType};
...
impl RubyAnalyzer {
    ...
    ) -> crate::legacy::parser::Result<RubyAnalysisResult> {
...
mod tests {
    ...
    use crate::legacy::parser::ruby::types::RubyDefinitionType;
    ...
    #[test]
    fn test_analyze_simple_ruby_code() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_analyzer_with_complex_ruby_code() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let ruby_code = r#"
...
"#;
    ...
    #[test]
    fn test_analysis_result_methods() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let ruby_code = r#"
class Test
  def method1; end
...
"#;
    ...
    fn test_error_handling() {
        ...
        // use crate::legacy::parser::parser::{GenericParser, LanguageParser};
    ...
    #[test]
    fn test_analyzer_with_sample_rb_fixture() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let fixture_path = "src/legacy/parser/ruby/fixtures/sample.rb";
    ...
    #[test]
    fn test_analyzer_with_monolith_sample_1_rb_fixture() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let fixture_path = "src/legacy/parser/ruby/fixtures/monolith_sample_1.rb";
        let ruby_code = std::fs::read_to_string(fixture_path)
    ...
    #[test]
    fn test_analyzer_with_references_test_rails_rb_fixture() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let fixture_path = "src/legacy/parser/ruby/fixtures/references_test_rails.rb";
        let ruby_code = std::fs::read_to_string(fixture_path)
    ...
    #[test]
    fn test_analyzer_with_references_test_tracing_rb_fixture() -> crate::legacy::parser::Result<()>
    {
        let analyzer = RubyAnalyzer::new();
        let fixture_path = "src/legacy/parser/ruby/fixtures/references_test_tracing.rb";
        let ruby_code = std::fs::read_to_string(fixture_path)
    ...
    #[test]
    fn test_analyzer_comprehensive_fixture_coverage() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let fixtures = [
            "src/legacy/parser/ruby/fixtures/sample.rb",
            "src/legacy/parser/ruby/fixtures/monolith_sample_1.rb",
            "src/legacy/parser/ruby/fixtures/references_test_rails.rb",
            "src/legacy/parser/ruby/fixtures/references_test_tracing.rb",
        ];
    ...
    #[test]
    fn test_analyzer_definition_filtering_and_grouping() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let fixture_path = "src/legacy/parser/ruby/fixtures/sample.rb";
        let ruby_code = std::fs::read_to_string(fixture_path)
            .expect("Should be able to read sample.rb fixture");
    ...
    fn test_analyzer_with_comprehensive_definitions_fixture() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let fixture_path = "src/legacy/parser/ruby/fixtures/comprehensive_definitions.rb";
        let ruby_code = std::fs::read_to_string(fixture_path)
    ...
    #[test]
    fn test_parse_and_analyze_simple() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let code = r#"
class User
  def initialize(name)
...
"#;
    ...
    #[test]
    fn test_analyzer_v2_with_expressions() -> crate::legacy::parser::Result<()> {
        let analyzer = RubyAnalyzer::new();
        let code = r#"
class Profile
  def settings
...
"#;
        ...
        let has_assignment = result.references.iter().any(|r| {
            r.reference_type
                == crate::legacy::parser::ruby::references::types::RubyReferenceType::Assignment
        });
        let has_call = result.references.iter().any(|r| {
            r.reference_type
                == crate::legacy::parser::ruby::references::types::RubyReferenceType::Call
        });
