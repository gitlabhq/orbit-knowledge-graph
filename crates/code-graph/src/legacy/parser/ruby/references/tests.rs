...
mod expression_tests {
    ...
    #[test]
    fn test_expression_extraction_for_basic_use_cases() -> crate::legacy::parser::Result<()> {
        let code = r#"
class User
...
"#;
    ...
    #[test]
    fn test_variable_tracking_expressions() -> crate::legacy::parser::Result<()> {
        let code = r#"
class Profile
   def settings
       # method body
...
"#;
    ...
    #[test]
    fn test_instance_variable_expressions() -> crate::legacy::parser::Result<()> {
        let code = r#"
class UserService
  def initialize(user)
    @user = user
...
"#;
    ...
    #[test]
    fn test_constant_scoped_method_calls() -> crate::legacy::parser::Result<()> {
        let code = r#"
...
"#;
    ...
    #[test]
    fn test_method_chaining_with_arguments() -> crate::legacy::parser::Result<()> {
        let code = r#"
class User
  def posts
  end
...
"#;
    ...
    #[test]
    fn test_class_and_module_variable_expressions() -> crate::legacy::parser::Result<()> {
        let code = r#"
class Counter
  @@count = 0
...
"#;
    ...
    #[test]
    fn test_block_and_yield_expressions() -> crate::legacy::parser::Result<()> {
        let code = r#"
class Collection
  def each
    yield
...
"#;
    ...
    #[test]
    fn test_safe_navigation_operator() -> crate::legacy::parser::Result<()> {
        let code = r#"
class User
  def profile
  end
...
"#;
    ...
    #[test]
    fn test_method_calls_on_method_return_values() -> crate::legacy::parser::Result<()> {
        let code = r#"
class UserService
  def find_user(id)
  end
...
"#;
    ...
    #[test]
    fn test_assignment_to_complex_expressions() -> crate::legacy::parser::Result<()> {
        let code = r#"
...
"#;
    ...
    #[test]
    fn test_nested_constant_access() -> crate::legacy::parser::Result<()> {
        let code = r#"
module Api
  module V1
