use crate::legacy::parser::imports::ImportedSymbolInfo;
use crate::legacy::parser::ruby::types::{RubyFqn, RubyImportType};
...
mod import_tests {
    ...
    use crate::legacy::parser::ruby::analyzer::RubyAnalyzer;
    use crate::legacy::parser::ruby::types::RubyImportType;
