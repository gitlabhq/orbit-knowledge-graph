use crate::legacy::parser::python::types::PythonDefinitionInfo;
...
mod definition_tests {
    ...
    use crate::legacy::parser::python::fqn::python_fqn_to_string;
    use crate::legacy::parser::python::types::PythonDefinitionType;
