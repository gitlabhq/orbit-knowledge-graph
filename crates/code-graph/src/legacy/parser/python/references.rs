...
mod tests {
    ...
    use crate::legacy::parser::python::analyzer::{PythonAnalysisResult, PythonAnalyzer};
    ...
    fn analyze_python_code(code: &str) -> crate::legacy::parser::Result<PythonAnalysisResult> {
    ...
    fn build_python_symbol_table(code: &str) -> crate::legacy::parser::Result<SymbolTableTree> {
        let parser = GenericParser::default_for_language(SupportedLanguage::Python);
        let parse_result = parser.parse(code, Some("test.py"))?;
    ...
    #[test]
    fn test_simple_function_reference() -> crate::legacy::parser::Result<()> {
        let code = r#"
def foo():
    pass
...
"#;
        ...
        match &reference.target {
            ReferenceTarget::Resolved(target) => match &**target {
                crate::legacy::parser::python::types::PythonTargetResolution::Definition(
                    def_info,
                ) => {
    ...
    #[test]
    fn test_method_call_on_instance() -> crate::legacy::parser::Result<()> {
        let code = r#"
class MyClass:
    def method(self):
        pass
...
"#;
    ...
    #[test]
    fn test_unresolved_reference() -> crate::legacy::parser::Result<()> {
        let code = r#"
undefined_function()
"#;
        let result = analyze_python_code(code)?;
    ...
    #[test]
    fn test_imported_function_reference() -> crate::legacy::parser::Result<()> {
        let code = r#"
...
"#;
        ...
        match &reference.target {
            ReferenceTarget::Resolved(target) => match &**target {
                crate::legacy::parser::python::types::PythonTargetResolution::ImportedSymbol(
                    import_info,
                ) => {
    ...
    #[test]
    fn test_aliased_import_reference() -> crate::legacy::parser::Result<()> {
        let code = r#"
import numpy as np
np.array()
"#;
        ...
        match &reference.target {
            ReferenceTarget::Resolved(target) => {
                match &**target {
                    crate::legacy::parser::python::types::PythonTargetResolution::PartialResolution(partial) => {
                        assert_eq!(partial.symbol_chain.as_str(), "np.array()");
                        // The partial resolution should point to the import
                        match *partial.target {
                            crate::legacy::parser::python::types::PythonTargetResolution::ImportedSymbol(_) => {}
    ...
    #[test]
    fn test_nested_function_scope() -> crate::legacy::parser::Result<()> {
        let code = r#"
def outer():
    def inner():
        pass
...
"#;
    ...
    #[test]
    fn test_class_method_types() -> crate::legacy::parser::Result<()> {
        let code = r#"
class MyClass:
...
"#;
    ...
    #[test]
    fn test_lambda_reference() -> crate::legacy::parser::Result<()> {
        let code = r#"
...
"#;
    ...
    #[test]
    fn test_conditional_binding() -> crate::legacy::parser::Result<()> {
        let code = r#"
def foo():
    pass
...
"#;
    ...
    #[test]
    fn test_chained_attribute_access() -> crate::legacy::parser::Result<()> {
        let code = r#"
class A:
    def method_a(self):
        return self
...
"#;
    ...
    #[test]
    fn test_self_method_call() -> crate::legacy::parser::Result<()> {
        let code = r#"
class MyClass:
    def method1(self):
        self.method2()
...
"#;
    ...
    #[test]
    fn test_for_loop_variable() -> crate::legacy::parser::Result<()> {
        let code = r#"
def process():
    pass
...
"#;
    ...
    #[test]
    fn test_reassignment() -> crate::legacy::parser::Result<()> {
        let code = r#"
def foo():
    pass
...
"#;
    ...
    #[test]
    fn test_global_vs_local_scope() -> crate::legacy::parser::Result<()> {
        let code = r#"
def global_func():
    pass
...
"#;
    ...
    #[test]
    fn test_try_except_bindings() -> crate::legacy::parser::Result<()> {
        let code = r#"
def foo():
    pass
...
"#;
    ...
    #[test]
    fn test_comprehension_scope() -> crate::legacy::parser::Result<()> {
        let code = r#"
def process(x):
    pass
...
"#;
    ...
    #[test]
    fn test_nested_class_reference() -> crate::legacy::parser::Result<()> {
        let code = r#"
class Outer:
    class Inner:
...
"#;
    ...
    #[test]
    fn test_decorator_reference() -> crate::legacy::parser::Result<()> {
        let code = r#"
...
"#;
    ...
    #[test]
    fn test_multiple_imports_same_name() -> crate::legacy::parser::Result<()> {
        let code = r#"
...
"#;
        ...
        match &reference.target {
            ReferenceTarget::Resolved(target) => {
                match &**target {
                    crate::legacy::parser::python::types::PythonTargetResolution::ImportedSymbol(import_info) => {
    ...
    #[test]
    fn test_walrus_operator_reference() -> crate::legacy::parser::Result<()> {
        let code = r#"
def get_value():
    return 42
...
"#;
    ...
    #[test]
    fn test_reference_count() -> crate::legacy::parser::Result<()> {
        let code = r#"
def func1():
    pass
...
"#;
    ...
    #[test]
    fn test_binding_cache_for_repeated_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_cache_with_shadowed_function_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_conditional_function_assignment_then_call() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_chained_method_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_class_instantiation_vs_function_call() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_decorated_function_call_resolution() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_callable_object_pattern() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_higher_order_function_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_recursive_function_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_partial_resolution_of_module_function_calls() -> crate::legacy::parser::Result<()> {
...
"#;
        ...
        for reference in [os_call, sys_call].iter().filter_map(|r| *r) {
            if let ReferenceTarget::Resolved(target) = &reference.target {
                match &**target {
                    crate::legacy::parser::python::types::PythonTargetResolution::PartialResolution(_) => {}
    ...
    #[test]
    fn test_match_statement_with_function_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_comprehension_with_function_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_exception_handler_function_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_async_function_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_property_getter_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_staticmethod_and_classmethod_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_nested_function_call_in_arguments() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_walrus_operator_function_call() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_function_call_in_f_string() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_multiple_inheritance_method_calls() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_find_references_bails_out_on_low_stack() -> crate::legacy::parser::Result<()> {
