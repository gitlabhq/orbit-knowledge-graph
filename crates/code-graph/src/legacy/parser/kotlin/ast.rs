...
use crate::legacy::parser::kotlin::analyzer::KotlinAnalyzerResult;
use crate::legacy::parser::kotlin::imports::parse_import_node;
use crate::legacy::parser::kotlin::types::{
...
use crate::legacy::parser::kotlin::utils::{
    get_child_by_any_kind, get_child_by_kind, get_children_by_kind,
};
...
pub(in crate::legacy::parser::kotlin) struct AstParseResult {
...
pub(in crate::legacy::parser::kotlin) fn parse_ast(ast: &AstRootNode) -> KotlinAnalyzerResult {
...
mod tests {
    ...
    fn test_property_init_when_expression_is_captured() {
        ...
        match x_definition.metadata.as_ref().unwrap() {
            crate::legacy::parser::kotlin::types::KotlinDefinitionMetadata::Field {
                init, ..
            } => {
                let init = init
                    .as_ref()
    ...
    fn test_function_init_try_expression_is_captured() {
        ...
        match a_definition.metadata.as_ref().unwrap() {
            crate::legacy::parser::kotlin::types::KotlinDefinitionMetadata::Function {
                init,
                ..
            } => {
                let init = init
