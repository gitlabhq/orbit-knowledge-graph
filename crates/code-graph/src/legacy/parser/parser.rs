...
macro_rules! define_languages {
    (
        ...
        /// use crate::legacy::parser::parser::supported_language_from_str;
        ...
        /// # Example
        /// ```
        /// use crate::legacy::parser::parser::detect_language_from_extension;
...
pub fn create_ruby_parser() -> crate::legacy::parser::ruby::parser::RubyParser {
    crate::legacy::parser::ruby::parser::RubyParser::new()
}

/// Create a specialized parser for TypeScript that uses swc instead of ast-grep
pub fn create_typescript_parser() -> crate::legacy::parser::typescript::parser::TypeScriptParser {
    crate::legacy::parser::typescript::parser::TypeScriptParser::new()
}

/// Create a parser based on the language type
pub enum ParserType {
    TreeSitter(GenericParser),
    Ruby(crate::legacy::parser::ruby::parser::RubyParser),
    TypeScript(crate::legacy::parser::typescript::parser::TypeScriptParser),
}
...
pub enum UnifiedParseResult<'a> {
    ...
    TypeScript(ParseResult<'a, crate::legacy::parser::typescript::types::TypeScriptSwcAst>),
}
