...
use crate::legacy::parser::rust::definitions::extract_definitions_from_map;
use crate::legacy::parser::rust::fqn::{build_fqn_and_node_indices, rust_fqn_to_string};
use crate::legacy::parser::rust::types::{RustDefinitionType, RustFqn, RustImportType};
...
impl RustAnalyzer {
    ...
    ) -> crate::legacy::parser::Result<RustAnalysisResult> {
...
mod tests {
    ...
    #[test]
    fn test_rust_analyzer_builds_fqn_map() -> crate::legacy::parser::Result<()> {
...
"#;
    ...
    #[test]
    fn test_rust_analyzer_empty_result() -> crate::legacy::parser::Result<()> {
        let analyzer = RustAnalyzer::new();
        let rust_code = r#"
fn simple_function() {
    println!("Hello, world!");
...
"#;
    ...
    #[test]
    fn test_rust_analyzer_comprehensive_definitions() -> crate::legacy::parser::Result<()> {
        let analyzer = RustAnalyzer::new();
        let rust_code = r#"
mod utils {
...
"#;
    ...
    #[test]
    fn test_rust_analyzer_integrates_with_imports() -> crate::legacy::parser::Result<()> {
        let analyzer = RustAnalyzer::new();
        let rust_code = r#"
