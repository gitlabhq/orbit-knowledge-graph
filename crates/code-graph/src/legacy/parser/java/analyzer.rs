...
#[cfg(test)]
mod tests {
    use crate::legacy::parser::{LanguageParser, SupportedLanguage, parser::GenericParser};
    ...
    fn test_definition_grouping_and_filtering() {
        ...
        let fixture_path = "src/legacy/parser/java/fixtures/ComprehensiveJavaDefinitions.java";
    ...
    fn test_very_long_call_chain_fixture_does_not_stack_overflow() {
        let analyzer = JavaAnalyzer::new();
        let fixture_path = "src/legacy/parser/java/fixtures/VeryLongCallChain.java";
        let java_code = std::fs::read_to_string(fixture_path)
