...
use crate::legacy::parser::csharp::parser::parse_ast;
use crate::legacy::parser::csharp::types::{CSharpDefinitionType, CSharpFqn, CSharpImportType};
...
impl CSharpAnalyzer {
    ...
    ) -> crate::legacy::parser::Result<CSharpAnalysisResult> {
...
mod tests {
    ...
    fn test_comprehensive_definitions_fixture() {
        ...
        let fixture_path = "src/legacy/parser/csharp/fixtures/ComprehensiveCSharp.cs";
