...
mod tests {
    use super::*;
    use crate::legacy::parser::typescript::parser::parse_ast;
    use crate::legacy::parser::typescript::types::TypeScriptDefinitionType;
    ...
    fn test_swc_class_definition_extraction() {
        ...
        let ast = parse_ast(
            crate::legacy::parser::typescript::parser::EcmaDialect::TypeScript,
            "test.ts",
            code,
        )
        .unwrap();
...
mod tests_swc {
    ...
    use crate::legacy::parser::typescript::analyzer::TypeScriptAnalysisResult;
    use crate::legacy::parser::typescript::ast::typescript_fqn_to_string;
    use crate::legacy::parser::typescript::parser::TypeScriptParser;
    use crate::legacy::parser::typescript::types::{
        TypeScriptDefinitionInfo, TypeScriptDefinitionType,
    };
    use crate::utils::{Position, Range};
    ...
    #[test]
    fn test_analyze_simple_js_code() -> crate::legacy::parser::Result<()> {
    ...
    #[test]
    fn test_js_analyze_edge_cases_functions() -> crate::legacy::parser::Result<()> {
        let test_path = "src/legacy/parser/typescript/fixtures/javascript/functions.js";
        let result = get_analysis_result(test_path)?;
    ...
    #[test]
    fn test_analyze_classes_js_code() -> crate::legacy::parser::Result<()> {
        let test_path = "src/legacy/parser/typescript/fixtures/javascript/classes.js";
        let result = get_analysis_result(test_path)?;
    ...
    #[test]
    fn test_analyze_typescript_code() -> crate::legacy::parser::Result<()> {
        let test_path = "src/legacy/parser/typescript/fixtures/typescript/sample.ts";
        let result = get_analysis_result(test_path)?;
    ...
    #[test]
    fn test_analyze_enums_typescript_code() -> crate::legacy::parser::Result<()> {
        let test_path = "src/legacy/parser/typescript/fixtures/typescript/enums.ts";
        let result = get_analysis_result(test_path)?;
