...
mod swc_import_tests {
    ...
    #[test]
    fn test_import_extraction_typescript_code() -> crate::legacy::parser::Result<()> {
        let path = "src/legacy/parser/typescript/fixtures/typescript/imports.ts";
    ...
    #[test]
    fn test_mixed_imports() -> crate::legacy::parser::Result<()> {
        let code = r#"
    ...
    #[test]
    fn test_sva_require_or_import() -> crate::legacy::parser::Result<()> {
        let code = r#"
    ...
    #[test]
    fn test_import_with_assignment() -> crate::legacy::parser::Result<()> {
        let code = r#"
    ...
    #[test]
    fn test_advanced_import_or_require() -> crate::legacy::parser::Result<()> {
    ...
    #[test]
    fn test_dynamic_imports() -> crate::legacy::parser::Result<()> {
        let code = r#"
    ...
    #[test]
    fn test_require_imports_advanced() -> crate::legacy::parser::Result<()> {
        let code = r#"
    ...
    #[test]
    fn test_side_effect_imports_all() -> crate::legacy::parser::Result<()> {
        let code = r#"
