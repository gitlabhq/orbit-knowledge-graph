...
use crate::legacy::linker::analysis::{AnalysisService, types::GraphData};

use crate::legacy::linker::loading::{FileInfo, FileSource, ProcessingError, read_text_file};
use crate::legacy::linker::parsing::processor::FileProcessor;
                ...
                async move {
                    match content_res {
                        Ok(content) => {
                            ...
                            match parse_res {
                                crate::legacy::linker::parsing::processor::ProcessingResult::Success(
                                    file_result,
                                ) => IndexingProcessingResult::Success(file_result),
                                crate::legacy::linker::parsing::processor::ProcessingResult::Skipped(skipped) => {
                                    IndexingProcessingResult::Skipped(skipped)
                                }
                                crate::legacy::linker::parsing::processor::ProcessingResult::Error(errored) => {
