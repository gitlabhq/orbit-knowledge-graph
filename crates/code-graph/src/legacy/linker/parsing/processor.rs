use crate::legacy::linker::loading::FileInfo;
...
impl ImportedSymbols {
    ...
    pub fn iter_csharp(
        ...
        impl Iterator<
            Item = &crate::legacy::parser::imports::ImportedSymbolInfo<
                crate::legacy::parser::csharp::types::CSharpImportType,
                crate::legacy::parser::csharp::types::CSharpFqn,
            >,
        >,
    > {
        match self {
...
pub type RubyReference = ReferenceInfo<
    ...
    crate::legacy::parser::ruby::types::RubyFqn,
>;
