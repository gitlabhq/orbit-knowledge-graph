use crate::legacy::parser::kotlin::ast::kotlin_fqn_to_string;
use crate::legacy::parser::kotlin::types::KotlinDefinitionInfo;
use crate::legacy::parser::kotlin::types::KotlinDefinitionMetadata;
use crate::legacy::parser::kotlin::types::KotlinDefinitionType;
use crate::legacy::parser::kotlin::types::KotlinExpressionInfo;
use crate::legacy::parser::kotlin::types::KotlinFqn;
use rustc_hash::FxHashMap;
use rustc_hash::FxHashSet;

use crate::legacy::linker::analysis::languages::kotlin::types::KotlinScopeTree;
use crate::legacy::linker::analysis::languages::kotlin::types::ScopeContext;
use crate::legacy::linker::analysis::types::ImportedSymbolNode;
