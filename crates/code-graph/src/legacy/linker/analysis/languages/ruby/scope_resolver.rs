...
use crate::legacy::linker::analysis::types::{DefinitionNode, FqnType};
    ...
    pub fn add_definition(&mut self, fqn: String, node: DefinitionNode, fqn_type: &FqnType) {
        ...
        if let FqnType::Ruby(ruby_fqn) = fqn_type {
            match node_arc.definition_type {
                crate::legacy::linker::analysis::types::DefinitionType::Ruby(
...
mod tests {
    use super::*;
    use crate::legacy::linker::analysis::types::DefinitionType;
    use crate::legacy::linker::analysis::types::FqnType;
