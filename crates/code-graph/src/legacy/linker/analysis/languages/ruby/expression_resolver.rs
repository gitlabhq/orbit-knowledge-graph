...
use crate::legacy::linker::analysis::types::{
    ConsolidatedRelationship, DefinitionNode, DefinitionType,
};
use crate::legacy::linker::graph::RelationshipType;
use crate::legacy::linker::parsing::processor::{References, RubyReference};
use crate::legacy::parser::ruby::types::RubyDefinitionType;
use crate::legacy::parser::ruby::{
...
impl ExpressionResolver {
    ...
    pub fn add_definition(
        ...
        fqn: String,
        node: DefinitionNode,
        fqn_type: &crate::legacy::linker::analysis::types::FqnType,
    ) {
...
mod tests {
    use super::*;
    use crate::legacy::linker::analysis::types::{DefinitionType, FqnType};
    use crate::legacy::parser::ruby::types::{RubyDefinitionType, RubyFqn};
    ...
    fn test_expression_resolver_basic() {
        ...
        let node = DefinitionNode::new(
            FqnType::Ruby(RubyFqn {
                parts: std::sync::Arc::new(smallvec::SmallVec::from_vec(vec![
                    crate::legacy::parser::ruby::types::RubyFqnPart::new(
                        crate::legacy::parser::ruby::types::RubyFqnPartType::Class,
                        "User".to_string(),
                        Range::new(Position::new(1, 0), Position::new(1, 4), (0, 4)),
                    ),
                    crate::legacy::parser::ruby::types::RubyFqnPart::new(
                        crate::legacy::parser::ruby::types::RubyFqnPartType::Method,
                        "save".to_string(),
        ...
        let ruby_fqn = RubyFqn {
            parts: std::sync::Arc::new(smallvec::SmallVec::from_vec(vec![
                crate::legacy::parser::ruby::types::RubyFqnPart::new(
                    ...
                    "User".to_string(),
                    Range::new(
                        crate::utils::Position { line: 1, column: 0 },
                        crate::utils::Position { line: 1, column: 4 },
                        (0, 4),
                    ),
                ),
                crate::legacy::parser::ruby::types::RubyFqnPart::new(
                    ...
                    "save".to_string(),
                    Range::new(
                        crate::utils::Position { line: 2, column: 0 },
                        crate::utils::Position { line: 2, column: 4 },
                        (20, 24),
                    ),
                ),
            ])),
        ...
        resolver.add_definition(
            "User#save".to_string(),
            node,
            &crate::legacy::linker::analysis::types::FqnType::Ruby(ruby_fqn),
        );
