...
use crate::legacy::linker::analysis::types::{DefinitionType, GraphData};
...
use crate::legacy::parser::SupportedLanguage;
...
async fn test_inheritance_relationships() {
    ...
    assert_eq!(
        ...
        DefinitionType::Ruby(crate::legacy::parser::ruby::types::RubyDefinitionType::Class)
    );
    assert_eq!(
