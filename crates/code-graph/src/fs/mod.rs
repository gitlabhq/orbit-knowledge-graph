...
/// A file discovered on the filesystem, with its content loaded and language detected.
#[derive(Debug, Clone)]
...
/// Raw file info before content is loaded.
#[derive(Debug, Clone)]
pub struct FileInfo {
    pub path: PathBuf,
}
...
pub trait FileSource {
    ...
    fn stream_files(self, config: &FsConfig) -> BoxStream<'static, Result<FileInfo, Self::Error>>;
}

/// Walks a directory tree with gitignore support, streaming discovered files.
#[derive(Debug, Clone)]
