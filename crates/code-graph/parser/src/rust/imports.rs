...
mod tests {
    ...
    #[test]
    fn test_basic_use_imports() -> crate::Result<()> {
        let rust_code = r#"
...
"#;
    ...
    #[test]
    fn test_glob_imports() -> crate::Result<()> {
        let rust_code = r#"
use std::collections::*;
use std::prelude::*;
"#;
    ...
    #[test]
    fn test_aliased_imports() -> crate::Result<()> {
        let rust_code = r#"
...
"#;
    ...
    #[test]
    fn test_extern_crate_imports() -> crate::Result<()> {
        let rust_code = r#"
extern crate serde;
extern crate log;
"#;
    ...
    #[test]
    fn test_aliased_extern_crate_imports() -> crate::Result<()> {
        let rust_code = r#"
...
"#;
    ...
    #[test]
    fn test_re_exports() -> crate::Result<()> {
        let rust_code = r#"
...
"#;
    ...
    #[test]
    fn test_module_declarations() -> crate::Result<()> {
        let rust_code = r#"
mod network;
mod database;
mod utils;
"#;
    ...
    #[test]
    fn test_import_scopes_with_fqn_integration() -> crate::Result<()> {
        let rust_code = r#"
...
"#;
        ...
        let (_node_fqn_map, _, _, imports) =
            crate::rust::fqn::build_fqn_and_node_indices(&parser_result.ast);
    ...
    #[test]
    fn test_comprehensive_mixed_imports() -> crate::Result<()> {
        let rust_code = r#"
...
"#;
    ...
    #[test]
    fn test_import_range_information() -> crate::Result<()> {
...
"#;
    ...
    #[test]
    fn test_use_group_unique_ranges() -> crate::Result<()> {
    ...
    #[test]
    fn test_use_group_imports() -> crate::Result<()> {
        let rust_code = r#"
use std::io::{Error, Result};
use crate::utils::{Position, Range, node_to_range};
...
"#;
    ...
    #[test]
    fn test_complex_import_patterns() -> crate::Result<()> {
        let rust_code = r#"
...
"#;
    ...
    #[test]
    fn test_public_glob_re_export() -> crate::Result<()> {
        let rust_code = r#"
pub use std::collections::*;
pub use crate::utils::*;
"#;
    ...
    #[test]
    fn test_complex_use_group_patterns() -> crate::Result<()> {
