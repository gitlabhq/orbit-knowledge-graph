...
use crate::references::{ReferenceInfo, ReferenceTarget};
use crate::ruby::definitions::{RubyDefinitionInfo, create_definition_from_fqn};
use crate::ruby::imports::RubyImportedSymbolInfo;
use crate::ruby::references::expressions::{
...
use crate::ruby::types::{RubyFqn, RubyFqnPart, RubyFqnPartType, RubyImportType, constants};
...
mod tests {
    ...
    #[test]
    fn test_definition_extraction_basic() -> crate::Result<()> {
        let code = r#"
class User
  def initialize(name)
    @name = name
...
"#;
    ...
    #[test]
    fn test_context_tracking() -> crate::Result<()> {
        let code = r#"
...
"#;
        ...
        let lambda_defs: Vec<_> = definitions
            .iter()
            .filter(|d| d.definition_type == crate::ruby::types::RubyDefinitionType::Lambda)
            .collect();
        let proc_defs: Vec<_> = definitions
            .iter()
            .filter(|d| d.definition_type == crate::ruby::types::RubyDefinitionType::Proc)
            .collect();
