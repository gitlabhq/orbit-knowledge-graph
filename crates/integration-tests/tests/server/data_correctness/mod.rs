...
async fn data_correctness() {
    ...
    run_subtests_shared!(
        ...
        search::search_file_content_starts_with,
        search::search_file_content_ends_with,
        search::search_file_content_is_null_matches_binary,
        search::search_file_content_is_not_null_excludes_binary,
        search::search_file_content_combined_with_physical,
        search::search_definition_content_selective,
        search::search_file_content_filter_without_selecting_column,
        search::search_file_content_filter_without_selecting_column_no_match,
        search::search_file_content_is_null_filter_without_selecting_column,
        ...
        traversal::traversal_variable_length_floor_skips_shallow,
        ...
        pagination::cursor_aggregation_pages_cover_all_groups,
        pagination::cursor_path_finding_pages_cover_all_paths,
        pagination::cursor_path_finding_is_deterministic,
        pagination::cursor_traversal_three_hop_pages_cover_all_edges,
        pagination::cursor_traversal_four_hop_pages_cover_all_edges,
        pagination::cursor_traversal_with_filters_desc_pages_return_exact_matches,
        pagination::cursor_traversal_cross_namespace_pages_cover_scoped_edges,
        pagination::cursor_aggregation_multi_hop_desc_seek_covers_all_groups,
        pagination::cursor_traversal_multi_hop_with_redaction_covers_authorized_edges,
        pagination::cursor_after_token_with_sql_metacharacters_is_parameterized,
