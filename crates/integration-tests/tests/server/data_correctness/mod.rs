...
async fn data_correctness() {
    ...
    run_subtests_shared!(
        ...
        security::aggregation_vulnerability_property_grouping_reporter_only_sees_no_rows,
        security::aggregation_vulnerability_property_grouping_filter_oracle_is_neutralized,
        security::aggregation_vulnerability_property_grouping_security_manager_sees_bucket,
        security::aggregation_vulnerability_property_grouping_sql_drops_reporter_paths,
