...
use code_graph_linker::indexer::{IndexingConfig, RepositoryIndexer};
use code_graph_linker::loading::DirectoryFileSource;
...
fn build_index_output(
    repo_name: &str,
    path: &str,
    result: &code_graph_linker::indexer::RepositoryIndexingResult,
    show_stats: bool,
) -> IndexOutput {
