...
// yaml_test!(python_imported_symbol_fallback_matrix, "python/imported_symbol_fallback_matrix.yaml");
yaml_test!(
...
yaml_test!(
    python_static_classmethod_calls,
...
// ── JavaScript ──
yaml_test!(
    js_commonjs_module_resolution,
    "javascript/commonjs_module_resolution.yaml"
);
yaml_test!(js_error_recovery, "javascript/error_recovery.yaml");
yaml_test!(js_extension_routing, "javascript/extension_routing.yaml");
yaml_test!(
    js_gitlab_monolith_config_resolution,
    "javascript/gitlab_monolith_config_resolution.yaml"
);
yaml_test!(
    js_jsx_and_generated_js_files,
    "javascript/jsx_and_generated_js_files.yaml"
);
yaml_test!(
    js_repo_boundary_enforcement,
    "javascript/repo_boundary_enforcement.yaml"
);
yaml_test!(js_security_hardening, "javascript/security_hardening.yaml");
yaml_test!(
    js_self_referential_reexport,
    "javascript/self_referential_reexport.yaml"
);
yaml_test!(
    js_vue_monolith_patterns,
    "javascript/vue_monolith_patterns.yaml"
);

// ── TypeScript ──
yaml_test!(ts_abstract_class, "typescript/abstract_class.yaml");
yaml_test!(
    ts_class_field_method_calls,
    "typescript/class_field_method_calls.yaml"
);
yaml_test!(ts_export_dedup, "typescript/export_dedup.yaml");
yaml_test!(
    ts_gitlab_monolith_barrels,
    "typescript/gitlab_monolith_barrels.yaml"
);
yaml_test!(
    ts_gitlab_monolith_patterns,
    "typescript/gitlab_monolith_patterns.yaml"
);
yaml_test!(
    ts_js_module_resolution,
    "typescript/js_module_resolution.yaml"
);
yaml_test!(ts_line_indexing, "typescript/line_indexing.yaml");
yaml_test!(
    ts_type_only_and_definitions,
