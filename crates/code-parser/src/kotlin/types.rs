...
pub(in crate::kotlin) type AstNode<'a> = Node<'a, StrDoc<SupportLang>>;
pub(in crate::kotlin) type AstRootNode = Root<StrDoc<SupportLang>>;

pub(in crate::kotlin) mod node_types {
