...
describe 'public/schemas/com.gitlab/ai_context/jsonschema/1-0-1' do
  ...
  context 'negative token values' do
    ...
    it 'should be invalid with negative cache_creation' do
      data = { cache_creation: -1 }
  ...
  context 'cache_creation specific tests' do
    it 'should be valid with only cache_creation set' do
      data = { cache_creation: 100 }

      errors = validate_schema(self.class.top_level_description, data)
      expect(errors).to be_empty
    end

    it 'should be valid with cache_creation at zero' do
      data = { cache_creation: 0 }

      errors = validate_schema(self.class.top_level_description, data)
      expect(errors).to be_empty
    end

    it 'should be valid with cache_creation as null' do
      data = { cache_creation: nil }
