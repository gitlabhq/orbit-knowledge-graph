...
| `orbit-skill` | Validates the standalone remote and local Orbit skill trees at build time: matching remote placeholders and local sections, unique combined paths, relative links, and documented CLI commands against the clap source inventory |
