...
Trigger a namespace backfill by re-enabling the namespace in GitLab (toggle the Orbit feature flag off and on). You can also simulate the Siphon event that the `NamespaceCodeBackfillDispatcher` consumes.
