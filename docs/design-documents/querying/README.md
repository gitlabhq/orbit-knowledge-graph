...
The [Orbit query frontend](orbit_query_frontend.md) is a compiler-level text API based on the openCypher 9 grammar, with Orbit-specific restrictions and extensions. Pest pairs lower directly into compiler Input. Remote requests still use the JSON Query DSL.
