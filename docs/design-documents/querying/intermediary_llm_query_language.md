...
The JSON schema (`crates/ontology/schema.json`) defines the structure, while the ontology (`fixtures/ontology/`) provides entity types, relationship types, and property definitions that are validated at runtime.
