...
- **Python, Kotlin, Java, C#, Go, Ruby, C, C++, PHP, and Bash** use tree-sitter grammars driven by the declarative DSL in `crates/code-graph/src/v2/langs/generic/`. Contributors adding a new language should follow [`docs/dev/adding-a-language.md`](../../dev/adding-a-language.md).
