...
The problem: the indexer needs a filtered stream of KG-relevant push events. Only Rails can do the filtering, because Rails owns the `EnabledNamespace` records and branch configuration.
