...
> [!note]
> [`orbit setup`](../../local/access/cli.md#set-up-your-ai-assistant) registers
> the local `orbit mcp serve` server in Claude Code, Codex, and OpenCode in one
> step. The hosted endpoint above still needs the manual configuration shown.
