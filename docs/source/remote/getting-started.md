...
- [Introduced](https://gitlab.com/groups/gitlab-org/-/work_items/22739) on GitLab Self-Managed in GitLab 19.2.2.
...
See [Use GitLab Orbit via MCP](access/mcp.md) for setup. Once configured, you have two tools: `query_graph` and `get_graph_schema`.
