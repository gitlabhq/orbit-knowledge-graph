...
The Orbit query language is a JSON-based domain specific language for
interacting with the knowledge graph.

You can use the query language with:

- The [Orbit API](https://docs.gitlab.com/api/orbit/).
- The query editor in the GitLab UI.
...
| `aggregation` | Group and aggregate results. For example, counts per project. |
