...
from ...models.mcp_auth_callback_body import McpAuthCallbackBody
...
def _get_kwargs(
    name: str,
    *,
    body: McpAuthCallbackBody | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/mcp/{name}/auth/callback".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Complete MCP OAuth
     ...
     Complete OAuth authentication for a Model Context Protocol (MCP) server using the authorization
    code.
    ...
    Args:
        ...
        directory (str | Unset):
        workspace (str | Unset):
        body (McpAuthCallbackBody | Unset):
