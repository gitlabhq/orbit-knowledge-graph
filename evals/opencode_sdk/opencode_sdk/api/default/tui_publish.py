...
def _get_kwargs(
    *,
    ...
    if (
        isinstance(body, EventTuiPromptAppend)
        or isinstance(body, EventTuiCommandExecute)
        or isinstance(body, EventTuiToastShow)
    ):
...
def sync_detailed(
    *,
    ...
    Args:
        directory (str | Unset):
        workspace (str | Unset):
        body (EventTuiCommandExecute | EventTuiPromptAppend | EventTuiSessionSelect |
            EventTuiToastShow | Unset):
