...
class EventTodoUpdated:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast("Literal['todo.updated']", d.pop("type"))
        if type_ != "todo.updated":
            raise ValueError(f"type must match const 'todo.updated', got '{type_}'")
        ...
        event_todo_updated.additional_properties = d
