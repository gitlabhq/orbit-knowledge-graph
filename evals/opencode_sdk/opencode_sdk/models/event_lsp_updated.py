...
class EventLspUpdated:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast("Literal['lsp.updated']", d.pop("type"))
        if type_ != "lsp.updated":
            raise ValueError(f"type must match const 'lsp.updated', got '{type_}'")
        ...
        event_lsp_updated.additional_properties = d
