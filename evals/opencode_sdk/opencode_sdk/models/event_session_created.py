...
class EventSessionCreated:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast("Literal['session.created']", d.pop("type"))
        if type_ != "session.created":
            raise ValueError(f"type must match const 'session.created', got '{type_}'")
        ...
        event_session_created.additional_properties = d
