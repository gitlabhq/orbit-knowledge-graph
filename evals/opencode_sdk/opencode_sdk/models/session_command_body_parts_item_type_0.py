...
T = TypeVar("T", bound="SessionCommandBodyPartsItemType0")


@_attrs_define
class SessionCommandBodyPartsItemType0:
    """
    Attributes:
        type_ (Literal['file']):
        mime (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        session_command_body_parts_item_type_0 = cls(
            type_=type_,
            mime=mime,
            url=url,
            id=id,
        ...
        session_command_body_parts_item_type_0.additional_properties = d
        return session_command_body_parts_item_type_0
