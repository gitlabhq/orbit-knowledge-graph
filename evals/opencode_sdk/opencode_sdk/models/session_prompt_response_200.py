...
T = TypeVar("T", bound="SessionPromptResponse200")


@_attrs_define
class SessionPromptResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        session_prompt_response_200 = cls(
            info=info,
            parts=parts,
        )

        session_prompt_response_200.additional_properties = d
        return session_prompt_response_200
