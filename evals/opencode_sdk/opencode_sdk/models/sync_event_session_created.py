...
class SyncEventSessionCreated:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name = cast("Literal['session.created.1']", d.pop("name"))
        if name != "session.created.1":
            raise ValueError(f"name must match const 'session.created.1', got '{name}'")
        ...
        sync_event_session_created.additional_properties = d
