...
class SyncEventMessageUpdated:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name = cast("Literal['message.updated.1']", d.pop("name"))
        if name != "message.updated.1":
            raise ValueError(f"name must match const 'message.updated.1', got '{name}'")
        ...
        sync_event_message_updated.additional_properties = d
