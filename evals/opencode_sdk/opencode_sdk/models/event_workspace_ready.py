...
class EventWorkspaceReady:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast("Literal['workspace.ready']", d.pop("type"))
        if type_ != "workspace.ready":
            raise ValueError(f"type must match const 'workspace.ready', got '{type_}'")
        ...
        event_workspace_ready.additional_properties = d
