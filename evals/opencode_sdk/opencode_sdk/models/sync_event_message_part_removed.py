...
class SyncEventMessagePartRemoved:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name = cast("Literal['message.part.removed.1']", d.pop("name"))
        if name != "message.part.removed.1":
            raise ValueError(f"name must match const 'message.part.removed.1', got '{name}'")
        ...
        sync_event_message_part_removed.additional_properties = d
