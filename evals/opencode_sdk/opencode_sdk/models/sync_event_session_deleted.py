...
class SyncEventSessionDeleted:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name = cast("Literal['session.deleted.1']", d.pop("name"))
        if name != "session.deleted.1":
            raise ValueError(f"name must match const 'session.deleted.1', got '{name}'")
        ...
        sync_event_session_deleted.additional_properties = d
