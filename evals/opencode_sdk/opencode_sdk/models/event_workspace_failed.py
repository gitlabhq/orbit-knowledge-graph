...
class EventWorkspaceFailed:
    """
    Attributes:
        type_ (Literal['workspace.failed']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast("Literal['workspace.failed']", d.pop("type"))
        if type_ != "workspace.failed":
            raise ValueError(f"type must match const 'workspace.failed', got '{type_}'")
        ...
        event_workspace_failed.additional_properties = d
