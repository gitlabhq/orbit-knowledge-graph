...
class EventTuiPromptAppend:
    """
    Attributes:
        type_ (Literal['tui.prompt.append']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast("Literal['tui.prompt.append']", d.pop("type"))
        if type_ != "tui.prompt.append":
            raise ValueError(f"type must match const 'tui.prompt.append', got '{type_}'")
        ...
        event_tui_prompt_append.additional_properties = d
