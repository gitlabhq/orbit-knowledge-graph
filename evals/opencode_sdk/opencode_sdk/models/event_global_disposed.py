...
class EventGlobalDisposed:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast("Literal['global.disposed']", d.pop("type"))
        if type_ != "global.disposed":
            raise ValueError(f"type must match const 'global.disposed', got '{type_}'")
        ...
        event_global_disposed.additional_properties = d
