...
class ContextOverflowError:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        name = cast("Literal['ContextOverflowError']", d.pop("name"))
        if name != "ContextOverflowError":
            raise ValueError(f"name must match const 'ContextOverflowError', got '{name}'")
        ...
        context_overflow_error.additional_properties = d
