...
class EventWorkspaceStatus:
    """
    Attributes:
        type_ (Literal['workspace.status']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast("Literal['workspace.status']", d.pop("type"))
        if type_ != "workspace.status":
            raise ValueError(f"type must match const 'workspace.status', got '{type_}'")
        ...
        event_workspace_status.additional_properties = d
