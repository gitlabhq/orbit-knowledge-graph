...
class EventSessionDiff:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast("Literal['session.diff']", d.pop("type"))
        if type_ != "session.diff":
            raise ValueError(f"type must match const 'session.diff', got '{type_}'")
        ...
        event_session_diff.additional_properties = d
