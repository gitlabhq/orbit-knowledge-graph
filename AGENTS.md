...
- **Orbit query frontend.** `crates/query-engine/opencypher/` adapts the official openCypher 9 M23 grammar to Pest and lowers pairs directly into compiler `Input`. It is a compiler-level API; remote requests still use JSON. See `docs/design-documents/querying/orbit_query_frontend.md`.
