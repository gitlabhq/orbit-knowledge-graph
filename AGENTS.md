...
- Container integration test lane filters cover every test exactly once (`integration-test-lane-coverage-check`, run locally with `mise lint:integration-test-lanes`)
