...
- Prose that LLMs read passes the prose lint (`lint:prose`, advisory; run locally with `mise run lint:prose -- --all`). Scope: prompts, setup, skills, agent guides, glossary, design and dev docs, templates.
